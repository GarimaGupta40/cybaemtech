    ...
    <>
      ...
      <div className="container mx-auto px-5 sm:px-6 lg:px-12 mt-12 mb-24 relative z-30">
        <div className="bg-white rounded-[24px] py-8 sm:py-10 px-4 sm:px-8 shadow-[0_15px_50px_rgba(0,0,0,0.08)] border border-slate-100">
          <p className="text-center text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase text-primary mb-6 sm:mb-8">
...
const WhatWeManage = () => {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-20 sm:py-28 bg-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,hsla(var(--primary),0.08),transparent_30%),radial-gradient(circle_at_top_right,hsla(var(--primary),0.08),transparent_26%),linear-gradient(180deg,#ffffff,rgba(244,248,255,0.88))]" />
      <div className="absolute inset-0 pointer-events-none opacity-50" style={{ backgroundImage: "radial-gradient(circle, hsla(var(--primary),0.10) 1px, transparent 1px)", backgroundSize: "28px 28px" }} />
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <motion.div variants={stagger} initial="hidden" animate={inView ? "visible" : "hidden"}>
...
/* ════════════════ CTA ════════════════ */
const CTASection = () => (
  <section className="py-20 sm:py-28 bg-[#f4f7fb] relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
      <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-8 items-center mb-16">
        {/* Left Content */}
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}>
          <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-primary/10 border border-primary/20 text-xs font-bold tracking-[0.1em] uppercase text-primary mb-6">
            <Layers size={14} /> Enterprise IT Infrastructure
          </motion.div>
          <motion.h2 variants={fadeUp} className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] text-[#0a1930] mb-6 tracking-tight">
            Ready to Modernize Your <span className="text-primary">IT Infrastructure?</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-base sm:text-lg text-slate-600 mb-10 max-w-xl leading-relaxed">
            Bring together support, security, cloud, network, and strategy in one premium operating model designed for scale, performance, and peace of mind.
          </motion.p>
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
            ...
            <MagneticButton>
              <Link to="/contact" className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-transparent px-7 py-3.5 text-sm font-semibold text-[#0a1930] transition-colors hover:bg-slate-50">
                Contact Our Experts <MessageSquare size={18} />
              </Link>
            </MagneticButton>
          </motion.div>
        </motion.div>
