...
import { leadershipSeoData } from "@/data/seo/leadershipSeo";
...
export const leaders = [
  ...
  {
    name: "Akshay Navle",
    role: "Chief Technology & Product Officer | AI Strategy, Product Innovation & Enterprise Transformation",
    description: [
      "Mr. Akshay Navle is a technology and product executive with 15 years of experience leading enterprise technology, AI-driven product innovation, and large-scale digital transformation initiatives. As the Chief Technology & Product Officer (CTPO) at Cybaem Tech, he defines the company's technology vision, product strategy, and AI innovation roadmap, ensuring every solution delivers measurable business outcomes rather than technology for its own sake.",
      "Throughout his career, he has successfully delivered enterprise solutions for global organizations including Capgemini, Wipro, Accenture, Dell Technologies, Praj Industries, and IGATE, leading large-scale transformation programs for Fortune 500 enterprises, including financial institutions such as Mastercard and Charles Schwab. His experience spans enterprise architecture, cloud transformation, cybersecurity, quality engineering, automation, and mission-critical technology delivery across complex business environments.",
      "At Cybaem Tech, Akshay oversees how every client engagement is envisioned, architected, built, secured, and scaled—from AI-powered platforms and enterprise applications to cloud infrastructure, cybersecurity, QA automation, and Generative AI solutions. By leading both technology and product, he ensures every engagement remains firmly aligned with the business outcomes it is intended to achieve: operational excellence, accelerated growth, stronger resilience, and sustainable competitive advantage.",
      "A strong advocate of AI-first product engineering, Akshay has architected and led the development of multiple proprietary AI platforms spanning enterprise automation, intelligent project management, AI-powered quotation systems, psychometric analytics, OCR-driven workflow automation, and intelligent requirement engineering. His expertise combines product strategy, solution architecture, artificial intelligence, business analytics, digital transformation, and technology commercialization to help organizations transform ideas into scalable digital products.",
      "Beyond engineering leadership, he serves as a strategic advisor to organizations on digital transformation, enterprise modernization, blockchain, ERP, health-tech innovation, AI adoption, and business process optimization.",
      "\"His leadership philosophy is centered on building technology with purpose—creating intelligent, secure, and future-ready solutions that generate measurable business value while enabling organizations to innovate with confidence.\""
    ],
  ...
  },
  {
    ...
    description: [
      "Yash Bhalekar plays a pivotal role in driving operational excellence and strategic business initiatives across Cybaem Tech. He is responsible for optimizing business processes, strengthening internal operations, and ensuring seamless collaboration between teams to deliver exceptional client experiences.",
  ...
  {
    name: "Mr. Sanjay Mahadeo Bobde",
    role: "Strategic Advisor – Enterprise Transformation, Digital Government / e-Governance & Public Sector Innovation",
    description: [
      "Mr. Sanjay Bobde is a distinguished business transformation executive with over three decades of experience leading enterprise modernization, digital Government, and technology-driven transformation across Government, Public Sector and Industry.",
      "An alumnus of IIT Bombay and IIM Ahmedabad, he has held senior leadership positions at Comat Technologies, Microsoft India, PwC India, National Institute for Smart Government (NISG), Ceinsys Technologies, and other high-impact organizations.",
      "Throughout his career, he has successfully led large-scale Digital India and e-Governance initiatives, organizational transformation, business consulting, program management, and public sector modernization for Central and State Governments. His expertise spans strategic planning, digital transformation, enterprise consulting, business incubation, operational excellence, and technology-led growth.",
      "As Founder of Yuga Globe Tech, he is committed to building impactful digital ecosystems across Healthcare, Insurance, AgriTech, Vocational Enrichment, Ports & Logistics, and community-centric innovation.",
      "At CybaemTech, Mr. Bobade provides strategic guidance on enterprise transformation, AI-driven innovation, digital strategy, business scalability, and sustainable growth, helping organizations navigate complex transformation journeys while creating measurable business and societal impact."
    ],
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-6 lg:gap-8 mb-16 lg:mb-24">
            {leaders.map((leader, index) => {
              ...
              return (
                <Link to={`/leadership/${leader.name.toLowerCase().replace(/\s+/g, '-')}`} key={index} className="w-full md:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1.5rem)] bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-100 hover:shadow-[0_20px_40px_rgba(15,76,255,0.06)] hover:-translate-y-1 transition-all duration-300 group flex flex-col relative z-10 cursor-pointer block">
                  {/* Image Container */}
                  ...
                  <div className="flex-grow flex flex-col pt-2">
                    <div className="flex items-center justify-between gap-3 mb-1">
                      ...
                      {leader.linkedin && (
                        <a href={leader.linkedin} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors shrink-0" onClick={(e) => e.stopPropagation()}>
                          <Linkedin size={14} />
                        </a>
                      )}
                    </div>
