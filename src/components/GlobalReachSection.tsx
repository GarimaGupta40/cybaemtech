...
const GlobalReachSection = () => {
  ...
  return (
    <section className="bg-[#F8FAFC] py-6 lg:py-8 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
          
          {/* Header */}
          <div className="text-center mb-10 max-w-3xl mx-auto">
            <motion.span variants={itemVariants} className="inline-block text-xs font-bold tracking-[0.15em] uppercase text-primary mb-3">
              GLOBAL FOOTPRINT
            </motion.span>
            <motion.h2 variants={itemVariants} className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
              Our <span className="text-primary italic font-light">Global Presence</span>
            </motion.h2>
          ...
          {/* Map Container */}
          <motion.div variants={itemVariants} className="relative w-full max-w-[1000px] mx-auto aspect-[16/8] min-h-[300px]">
          ...
          <motion.div variants={itemVariants} className="mt-[-40px] hidden md:flex justify-center relative z-20">
            <div className="bg-white rounded-full shadow-[0_0_20px_rgba(0,0,0,0.15)] border border-gray-100 px-7 py-3 flex flex-wrap items-center justify-center gap-8 sm:gap-12">
