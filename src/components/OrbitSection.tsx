      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-2/5 lg:pl-10 text-center lg:text-left mt-10 sm:mt-16 lg:mt-0">
            ...
            >
              <motion.h2 variants={itemVariants} className="font-display text-4xl sm:text-5xl lg:text-[54px] font-bold leading-[1.15] mb-5 sm:mb-6 text-[#0a1128] tracking-tight">
                Ready to <span className="text-[#0052cc]">Transform</span><br className="hidden lg:block" /> Your Business?
              </motion.h2>
