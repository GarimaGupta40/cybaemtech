...
if (strpos($contentType, 'application/json') !== false) {
    ...
    if ($input) {
        ...
        $name = $email = $phone = $category = $message = $sourcePage = '';
    }
} else {
    // Form data
    $name       = $_POST['name'] ?? '';
...
debugLog("Extracted values - Name: '$name', Email: '$email', Phone: '$phone', Category: '$category', Message: '$message', SourcePage: '$sourcePage'");
...
$stmt->bind_param("ssssss", $name, $email, $phone, $category, $message, $sourcePage);
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <table>
        ...
        <tr><td class="label">Service Category</td><td class="value">' . htmlspecialchars($category) . '</td></tr>
        <tr><td class="label">Your Message</td><td class="value">' . nl2br(htmlspecialchars($message)) . '</td></tr>
